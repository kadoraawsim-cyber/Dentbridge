        ...
        <div className="mb-8 grid gap-4 lg:grid-cols-3">
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            {nextActionCase ? (
              ...
              <p className="text-sm text-slate-500">{ui.nothingUrgent}</p>
            )}
          </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <p className="text-3xl font-bold tracking-tight text-slate-900">{liveActiveCases.length}</p>
          ...
          <div id="my-active-cases" className="mb-10">
            <div className="mb-4 flex items-center justify-between">
              ...
              <span className="rounded-full bg-emerald-100 px-3 py-1 text-xs font-semibold text-emerald-700">
                {liveActiveCases.length} {t('student.dashboard.assigned')}
              </span>
            </div>

            <div className="grid gap-5 md:grid-cols-2">
              {liveActiveCases.map((c) => {
              ...
              {recentCases.length === 0 ? (
                <div className="flex flex-col items-center justify-center px-6 py-14 text-center">
                  ...
                  <p className="font-semibold text-slate-700">
                    {t('student.dashboard.noCasesInPool')}
                  </p>
