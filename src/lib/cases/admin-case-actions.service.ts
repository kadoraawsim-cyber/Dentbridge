...
export async function executeAdminCaseAction(
  ...
  // ── Non-RPC actions ────────────────────────────────────────────────────────
  // Single-table case transitions guarded by the shared transition rules + a
  // conditional predicate so illegal transitions, terminal reopening, and
  // concurrent clobbering are all rejected.
  //
